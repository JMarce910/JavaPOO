...
public class POOEjerAprendizaje12 {
     ...
     * firma: crearPersona(). Este método rellena el objeto mediante un Scanner 
     * y le pregunta al usuario el nombre y la fecha de nacimiento de la persona
     * a crear, recordemos que la fecha de nacimiento debe guardarse en un Date 
     * y los guarda en el objeto. 
     * 
     ...
     * 
     *  Metodo mostrarPersona(): este método muestra la persona creada en 
     * el método anterior. 
     */
