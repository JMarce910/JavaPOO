 ...
 */
public class POOEjerAprendizaje13 {
    ...
    public static void main(String[] args) {
        ...
        service.crearCurso();
        System.out.println("La ganancia semanal del curso" + curso.getNombreCurso()+ " es: " + service.calcularGananciaSemanal());
