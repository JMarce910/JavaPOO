 ...
 * @author Pc
 */
public class POOEjerAprendizaje05 {

    /**
     * @param args the command line arguments
     * 
     * Realizar una clase llamada Cuenta (bancaria) que debe tener como mínimo 
     * los atributos: numeroCuenta (entero), el DNI del cliente (entero largo) y
     * el saldo actual (entero). Las operaciones asociadas a dicha clase son: 
